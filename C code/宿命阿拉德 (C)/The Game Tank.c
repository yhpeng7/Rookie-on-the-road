...
void p1_fire()
{
    ...
    else if(map[p1_ball_y][p1_ball_x]=='@'){map[p1_ball_y][p1_ball_x]='*';p1_ball_steer='%';}
    else if(map[p1_ball_y][p1_ball_x]=='#'||map[p1_ball_y][p1_ball_x]=='.')
...
void p2_fire()
{
    ...
    else if(map[p2_ball_y][p2_ball_x]=='@'){map[p2_ball_y][p2_ball_x]='*';p2_ball_steer='%';}
    else if(map[p2_ball_y][p2_ball_x]=='#'||map[p2_ball_y][p2_ball_x]=='.')

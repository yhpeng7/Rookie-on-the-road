...
Monster monsterArray[] = {
    {1, "投掷十夫长", 1, 10000, 1000, 100, 5, 10, 5, 1, {0, 0}},
    {2, "库罗猫妖", 2, 200, 8, 2, 5, 10, 5, 1, {0, 0}},
    {3, "园丁鲁尔", 8, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {4, "浮游石巨人", 8, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {5, "光之城主赛格哈特", 7, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {6, "罪恶之眼", 6, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {7, "黎明之传道士", 5, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {8, "罪恶之眼", 6, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {9, "罪恶之眼", 6, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {10, "罪恶之眼", 6, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {11, "罪恶之眼", 6, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {12, "罪恶之眼", 6, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {13, "罪恶之眼", 6, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {14, "罪恶之眼", 6, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {15, "罪恶之眼", 6, 100, 5, 2, 5, 10, 5, 1, {0, 0}},
    {16, "冰齿沙凡特", 9, 100, 5, 2, 5, 10, 5, 1, {0, 1}}
};
...
void Register()
{
    ...
    for(i=0;players[i].id !=0;i++);
        ...
        currPlayer -> id = i;       //游戏初始有一个vip玩家黑暗君主，id从1开始
